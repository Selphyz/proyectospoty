...
<div class="ContentForm">
		 	<form id="proof" action="" method="post" name="FormEntrar">
		 		<div class="input-group input-group-lg">
				  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
				  <input type="text" style="height:46px;" class="form-control" name="nombre" placeholder="Nombre" id="Nombre" required>
                </div>
                <br>
                <div class="input-group input-group-lg">
                ...
                <div class="input-group input-group-lg">
				  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
				  <input type="password" style="height:46px;" class="form-control" name="contraseña" placeholder="******" id="Correo" required>
                </div>
                <br>
				<button class="btn btn-lg btn-primary btn-block btn-signin" id="IngresoLog" type="submit">Entrar</button>
				
				<div class="opcioncontra"><a href="/proyectospoty/plogin.php">¿Ya tienes cuenta? Inicia sesión aqui</a></div>
		 	</form>
		 </div>	
		 </div>
